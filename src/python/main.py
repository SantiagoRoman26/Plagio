...
def main():
    ...
    archivos_referencia = obtener_archivos(config["path_archivos_referencia"])
    ...
    if archivos_test:
        ...
        hilo_red_nuronal = threading.Thread(target=generar_modelo_entrenado, args=(config["pares_textos_path"], ))                              #nuevo
        ...
        guardar_resultado(nombre_archivo, topico_con_mas_score, plagio, tiempo_que_tardo, porcentaje_de_plagio, config["path_resultado"], config["path_archivos_referencia"]) #aqui
