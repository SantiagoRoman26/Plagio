...
def generar_modelo_entrenado(pares_textos_path):
    ...
    #falta implementacion de las stopwords
    # Ingresar el numero maximo de palabras a considerar
    max_words = 10000
    #posible implementacion en el yml, necesita mas investigacion
    train_text1 = []
    train_text2 = []
    train_similarity = []
    ...
    modelo_entrenado.append((model, tokenizer, train_data1, train_data2)) #pasar 4 valores al helper global?

def calcular_similitud( text1, text2):
    model, tokenizer, train_data1, train_data2 = modelo_entrenado[0] # error de multiples valores?
