...
def obtener_oracion_mas_parecida_del_dataset(oracion, oracion_preparada, archivo_test_txt, archivos_referencia, sw):
    ...
    #print(archivo_test_txt)
    #print("---------------------------------------------------------------------------------")
    for archivo in archivos_referencia:
        if archivo is not None:
            #if obtener_similitud(".".join(archivo_test_txt), ".".join(archivo.texto)) > 0.9: #mayor
            ...
            if  numero> 0.8: #mayor
                ...
                for oracion_a_comparar in archivo.texto:
                    ...
                    #print("---------------------------------------------------------------")
                    #print("oracion preparada= "+oracion_preparada)
                    #print("---------------------------------------------------------------")
                    #similitud_textos = similitud(oracion_preparada, oracion_a_comparar_preparada)
                    #print("----------------"+str(similitud_textos)+"----------------")
